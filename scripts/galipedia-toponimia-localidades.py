...
def parseCountryName(name):
    ...
    elif name in [u"Alxeria", u"Etiopía", u"Exipto", u"Grecia", u"Iemen", u"Iraq", u"Israel", u"Malí", u"Oceanía",
                  u"Perú", u"Turquía", u"Xordania"]:
...
if len(sys.argv) != 2:
    ...
    print "    Italia, Malí, México, Oceanía, Países Baixos, Perú, Portugal, Reino Unido, Turquía, Xordania."
    sys.exit()
