...
def loadGeneratorList():
    ...
    generators.append(GalipediaLocalidadesGenerator(u"Austria", parsingMode="FirstSentence"))
    ...
    generators.append(GalipediaLocalidadesGenerator(u"Burkina Faso", parsingMode="FirstSentence"))
    ...
    generators.append(GalipediaLocalidadesGenerator(u"Corea do Norte", parsingMode="FirstSentence"))
    generators.append(GalipediaLocalidadesGenerator(u"Cuba"))
    generators.append(GalipediaLocalidadesGenerator(u"Dinamarca"))
    generators.append(GalipediaLocalidadesGenerator(u"Dominica", parsingMode="FirstSentence"))
    ...
    generators.append(GalipediaLocalidadesGenerator(u"Grecia", parsingMode="FirstSentence"))
    ...
    generators.append(GalipediaLocalidadesGenerator(u"Marrocos", parsingMode="FirstSentence"))
